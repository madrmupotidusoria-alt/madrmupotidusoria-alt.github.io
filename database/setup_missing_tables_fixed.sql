-- SCANORA - Setup Missing Tables Only (Fixed Version)
...
-- ========================================
-- CREATE RLS POLICIES (safe approach)
-- ========================================
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Users can manage own security" ON user_security;
    
    CREATE POLICY "Users can manage own security" ON user_security
        FOR ALL USING (auth.uid() = user_id);
    
    -- Activity policies
    DROP POLICY IF EXISTS "Users can manage own login history" ON user_login_history;
    DROP POLICY IF EXISTS "Users can manage own search history" ON user_search_history;
    DROP POLICY IF EXISTS "Users can manage own saved searches" ON user_saved_searches;
    ...
    DROP POLICY IF EXISTS "Users can manage own usage" ON user_usage;
    ...
    DROP POLICY IF EXISTS "Users can manage own trusted devices" ON user_trusted_devices;
